...
6. Make setup easy for other developers on their own machine.
...
5. AI provider switching works and new jobs use the selected provider.
6. Setup doc produces a working local install on a clean machine.
